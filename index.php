...
<head>
    ...
    <script type="text/javacsript" src="assets/js/jquery.js"></script>
    <script type="text/javacsript" src="assets/js/bootstrap.js"></script>
</head>
...
<body style="background: #f0f0f0">
    ...
    <span class="text-center">
        <h2>SISTEM INFORMASI LAUNDRY <br /> BAYAR MAHAL</h2>
    </span>
    <br />
    <br />
    <br />
