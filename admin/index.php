                        ...
                        <div class="panel-heading">
                            <h1>
                                ...
                                <span class="pull-right">
                                    <?php
                                    $proses =
                                    mysqli_query($koneksi,"SELECT * from transaksi where status='0'");
                                    echo
                    ...
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h1>
                                ...
                                <span class="pull-right">
                                    <?php
                                    $proses =mysqli_query($koneksi,"SELECT * from transaksi where status='1'");
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h1>
                                ...
                                <span class="pull-right">
                                    <?php
                                    $proses =mysqli_query($koneksi,"SELECT * from transaksi where status='2'");
                                    echo mysqli_num_rows($proses);
                                    ?>
                                </span>
                            </h1>
...
FROM transaksi as t
LEFT JOIN pelanggan as p ON t.pelanggan_id = p.pelanggan_id  order by
