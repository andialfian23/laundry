...
transaksi,pelanggan where transaksi_id='$id' and
...
?>
            ...
            <table class="table">
                ...
                <tr>
                    <th>Tgl. Selesai</th>
                    <th>:</th>
                    <td><?php echo $t['transaksi_tgl_selesai'];
?></td>
                </tr>
                <tr>
                    <th>Status</th>
...
echo "<div class='label labelwarning'>PROSES</div>";
}else if($t['transaksi_status']=="1"){
echo "<div class='label labelinfo'>DI CUCI</div>";
}else if($t['transaksi_status']=="2"){
echo "<div class='label labelsuccess'>SELESAI</div>";
}
?>
                    </td>
                </tr>
...
pakaian where pakaian_transaksi='$id'");
